...
sleep 5
ip -4 rule add oif WARP lookup 7844
ip -4 rule add table main suppress_prefixlength 0
ip -4 route add default dev WARP table 7844
ip -6 rule add oif WARP lookup 7844
ip -6 rule add table main suppress_prefixlength 0
ip -6 route add default dev WARP table 7844
EOF

    cat > /opt/warp-go/NonGlobalDown.sh << EOF
ip -4 rule delete oif WARP lookup 7844
ip -4 rule delete table main suppress_prefixlength 0
ip -6 rule delete oif WARP lookup 7844
